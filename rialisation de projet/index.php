 <?php
//  include "./loader.php";
 include " ./BLL/CompetenceBLO.php";
 include "./BLL/CityBLO.php";
$CompetenceBLO = new CompetenceBLO;
$Competences = $CompetenceBLO->GetAllStagiaiers();
$CityBLO = new CityBLO;
?> 
              ...
              <div class="card-body  p-0">
                ...
                <?php foreach ($Competences as $Competence) { ?>
                    <tr>
                        ...
                        <th scope="row">
                            <?= $Competence->GetFullName() ?>
                        </th>
                        <th>
                            <?= $Competence->GetEmail() ?>
                        </th>
                        <th>
                            <?= $Competence->GetPhone_number() ?>
                        </th>
                        <th>
                            <?= $Competence->GetAddress() ?>
                        </th>
                        <th>
                            <?= $CityBLO->getCityById($Competence->GetIdCity()) ?>
                        </th>
                        <th>
                            <a class="btn" name="deleteCompetence" href="Delete.php?Page=<?= $Competence->GetId() ?>"> <span><i  title="supprimer" class="material-icons" style="font-size:30px;color:red">delete</i>
</span></a>
                            <a class="btn" href="Views/gestionCompetences/editerCompetences.php?Page=<?= $Competence->GetId() ?>"> <i title="edit"  class="material-icons" style="font-size:30px;color:green">edit</i></a>
                        </th>
                    </tr>
                <?php } ?>
            </tbody>
